      ...
      <div className="workspaceLayout">
        ...
        <section className="workAreaScroll">
          <div className="workArea">
            ...
            {activeStep === "train" ? <TrainStep project={project} runner={runner} datasets={runnerDatasets} dataset={dataset} busy={busy} perform={perform} moveTo={moveTo} onSelect={setSelectedDatasetId} onEdit={() => { setDatasetEditRequested(true); moveTo("data"); }} /> : null}
